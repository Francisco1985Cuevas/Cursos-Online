		...
		<div id="main">
			<form name="formComunidad" id="formComunidad" method="post" action="resultados2.php">
				<fieldset>
					...
					<p>
						Paso 1: Elige Pa&iacute;s (obligatorio)<br />
			...
			<div id="loading"><img src="loading4.gif" border="0" /></div>
			<div id="divDestino"></div>
		</div>
		<script>
			// prepara el formulario cuando el DOM está preparado
			$(document).ready(function(){
				//Crear una variable "options", que es la que se le pasara a la funcion ajaxForm()
				var options = { 
					...
					//url:       url         //  sobreescribe el atributo 'action' del formulario(La pagina a la que se envia)
