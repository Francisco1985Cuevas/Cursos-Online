...
Configurar y Autocarga de Clases



Se empieza a programar el archivo: app/config/configurar.php
...
Se empieza a programar el archivo: app/vistas/inc/header.php

Se empieza a programar el archivo: app/vistas/inc/footer.php

NO funciona la parte que tiene que traer el css y el javascript,
no lee la carpeta public, creo que hay que ver como hacer con el archivo .htacces
----------------------------------------------------------------------------------
...
Clase Conexión Base de Datos Mysql

Se agregan constantes de definicion de base de datos en el archivo: app\config\configurar.php

Se va a programar el archivo que hace la conexion a la base de datos: app\librerias\Base.php

Se agrego una nueva linea en el constuctor de: app\controladores\Paginas.php
---------------------------------------------------------------------------------------------
...
Para el archivo: \public\.htaccess, en la parte de: RewriteBase /render2web_mvc2/public, se tiene que cambiar y apuntar
a la carpeta en donde tenemos el proyecto.
