<?php
	...
	class Estudiante
	{
		...
		{
			$sql = "SELECT t1.*, t2.nombre as nombre_seccion FROM estudiantes t1 JOIN secciones t2 on t1.id_seccion = t2.id";
		...
		public function view()
		{
			$sql = "SELECT t1.*, t2.nombre as nombre_seccion 
					FROM estudiantes t1 join secciones t2 on t1.id_seccion = t2.id
					WHERE t1.id = '{$this->id}'";
